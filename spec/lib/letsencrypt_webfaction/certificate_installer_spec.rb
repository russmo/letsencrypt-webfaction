...
RSpec.describe LetsencryptWebfaction::CertificateInstaller do
  ...
  let(:csr_private_key) { double 'private_key', to_pem: 'PRIVATE_KEY' }

  let(:certificate) { 'FULL CHAIN CERTIFICATE' }

  let(:cert_name) { 'test_auto_cert' }

  let(:cert_installer) { LetsencryptWebfaction::CertificateInstaller.new cert_name, certificate, csr_private_key, creds }
  ...
  context 'with existing certificate' do
    before :each do
      stub_request(:post, 'https://wfserverapi.example.com/')
        .with(body: "<?xml version=\"1.0\" ?><methodCall><methodName>update_certificate</methodName><params><param><value><string>oz7e1xz9r0mf0wgue22hsj8tgkhqyo74</string></value></param><param><value><string>test_auto_cert</string></value></param><param><value><string>FULL CHAIN CERTIFICATE</string></value></param><param><value><string>PRIVATE_KEY</string></value></param></params></methodCall>\n")
  ...
  context 'without existing certificate' do
    before :each do
      stub_request(:post, 'https://wfserverapi.example.com/')
        .with(body: "<?xml version=\"1.0\" ?><methodCall><methodName>create_certificate</methodName><params><param><value><string>oz7e1xz9r0mf0wgue22hsj8tgkhqyo74</string></value></param><param><value><string>testdomain_example_com</string></value></param><param><value><string>FULL CHAIN CERTIFICATE</string></value></param><param><value><string>PRIVATE_KEY</string></value></param></params></methodCall>\n")
        .to_return(status: 200, body: fixture('create_certificate_response.xml'))
    end
